...
public interface ImainCommandSystem {
   ...
   */
  void run(CommandSender sender, String commandLabel, Command command, String[] args, final ClassLoader classLoader)
      throws Exception;
   ...
   * @throws Exception 執行指令錯誤時回報錯誤訊息
   */
  void run(Player player, String commandLabel, Command command, String[] args, final ClassLoader classLoader)
      throws Exception;
